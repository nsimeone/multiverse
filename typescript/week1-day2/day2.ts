let pageName: string = "home"; 
let retryCount: number = 3; 
let isAutomated: boolean = true; 
...
const urls: string[] = ["site1.com", "site2.com", "site3.com"]

urls.forEach((url) => {
    console.log(`Checking ${url}`); 
}); 

const responseTimes: number[] = [0.2, 1.5, 3.1, 0.4, 5.0];
...
const pages: string[] = ["home", "about", "contact", "blog"];
